...
const CustomMobileLink = ({ href, title, onToggle, className = "" }) => {
  const router = useRouter();
      ...
      {isOpen && (
        ...
        >
          <nav className="flex items-center flex-col justify-center">
            <CustomMobileLink href="/" title="Home" onToggle={handleOpen} />
            <CustomMobileLink
              href="/about"
              title="About"
              onToggle={handleOpen}
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <button
              ...
              className={`${
                mode === "light" ? "bg-dark text-light" : "bg-light text-dark"
              } ml-3 flex items-center justify-center rounded-full p-1 sm:mx-2`}
            >
              {mode === "dark" ? (
                <SunIcon className="fill-dark" />
              ) : (
